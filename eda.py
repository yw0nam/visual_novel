...
temp = pd.read_csv("/home/wonjong/codes/2024_upper/visual_novel/data/data.remove_wrongstrings.replace_noun.filter_only_dict.remove_high_pitch.trim_dur.csv")
